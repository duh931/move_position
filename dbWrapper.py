...
class dbWrapper:
    ...
    def getBars(self,sSymbol,sBDay,sEDay,sBarType):
        sSQL = "select tradingday, bartime, openprice, highprice, lowprice, closeprice, volume from china_fut." + sSymbol + " where tradingday >= %s  and tradingday <= %s and bartype = %s  and bartime >= %s and bartime <= %s order by tradingday,id asc;"
...
# datas1 = dd.getNightBars('rb1710','20170505','20170505','Daily')
# datas2 = dd.getBars('jd1705','20170126','20170209','Daily')
# print datas1
# print datas2